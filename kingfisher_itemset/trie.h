...
extern int (*prunecand)(Node *t,Node *p,bitvector** amatr,int l,int* fr,int *kandi, int *order, int *oldaddr, int* row_lengths);
...
Node* searchChild(Node* p, int label, int* index,int* order);/* etsi p:st� labelin */
Node* binsearchChild(Node* p, int label, int* index,int* order);/* etsi p:st� labelin */
/* os. lapsi, palauta sen os. ja indeksi  */
void delChild(Node* p, int label,int* order);/* poista p:st� labelin os. lapsi */
